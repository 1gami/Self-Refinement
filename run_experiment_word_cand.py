...
# Direct                         0
# Basic Self-Refine              1, 2, 3
# Evidence-aware Self-Refine     1, 2, 3
# VitaminC-style Self-Refine     1, 2, 3
# WordR                          1
# WordCand                       1

# Basic iter=2보다 WordR iter=1이 좋은가?
# Evidence-aware iter=2보다 WordCand iter=1이 좋은가?
# iteration을 늘려도 일반 self-refine이 실제로 좋아지는가?
